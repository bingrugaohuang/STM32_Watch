...
typedef enum{
    ...
    MENU_EVENT_UP_SHORT,
    MENU_EVENT_UP_LONG,
    MENU_EVENT_UP_RELEASE,
    MENU_EVENT_DOWN_SHORT,
    MENU_EVENT_DOWN_LONG,
    MENU_EVENT_DOWN_RELEASE,
    MENU_EVENT_CONFIRM_SHORT,
    MENU_EVENT_CONFIRM_LONG,
    MENU_EVENT_CONFIRM_RELEASE,
